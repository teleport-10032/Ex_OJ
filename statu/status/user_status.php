...
<div class="container">
    <h3>
        <a href="/statu/status">ALL Status</a>
    </h3>
</div>
        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                <table class="table table-hover">
                    ...
                    $str = "select submit_id,submit_when,submit_problem,submit_statu ,submit_time, submit_memory, submit_language,submit_length,submit_user_mail,user_name,user_cheat,user_judgement,user_permission from status,user where submit_user_mail=user_mail and submit_user_mail='$user_mail' order by submit_id desc limit " . ($page - 1) * $page_size . "," . $page_size;
                    $mysqli->query("set names 'utf8'");
