...
<div class="container">
    <h3>
        <?php
        echo "
        <a href=\"/contest/contest_statu/my_status.php?contest_id=$contest_id&contest_passwd=$contest_passwd\">My Status</a>
        ";
        ?>
    </h3>
</div>
        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php
                    $str = "select submit_problem,submit_id,submit_when,contest_problem,submit_statu ,submit_time, submit_memory, submit_language,submit_length,submit_user_mail,user_name,user_cheat,user_judgement,user_permission from contest_status,user where submit_user_mail=user_mail and submit_contest='$contest_id'  order by submit_id desc limit " . ($page - 1) * $page_size . "," . $page_size;
