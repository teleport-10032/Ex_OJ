                ...
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <table class="table table-striped table-hover table-responsive">
                            ...
                            <tbody>
                            <?php
                            $str="select user_id,user_name,user_realname,user_mail,user_permission,user_available,user_create_time  from user where user_teacher=$teacher_id order by user_id desc limit ".($page-1)*$page_size.",".$page_size;
                            $result=$conn->query($str);
