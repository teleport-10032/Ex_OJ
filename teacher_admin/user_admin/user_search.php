...
if(isset($_SESSION["teacher_mail"]))
    $teacher_mail =  $_SESSION["teacher_mail"];
$str="select user_id  from user where user_mail='$teacher_mail'";
...
$sql = "select count(*) as amount from user where user_id=$teacher_id";
                ...
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <table class="table table-striped table-hover table-responsive">
                            ...
                            <tbody>
                            <?php
                            $str="select user_id,user_name,user_realname,user_mail,user_permission,user_available,user_create_time  from user where user_teacher=$teacher_id and (user_name like '%$search' or user_mail like  '%$search%')order by user_id";
                            $result=$conn->query($str);
