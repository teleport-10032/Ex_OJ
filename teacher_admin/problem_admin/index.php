...
$page_size = 10;
$sql = "select count(problem_id) as amount from problem,user where problem_author=user_id and user_mail='$user_mail'";
                ...
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <table class="table table-striped table-hover table-responsive">
                            ...
                            $str = "select problem_id,problem_title,user_name,problem_create_time,problem_visible,problem_testcase_path from user,problem where user_id=problem_author and user_mail='$user_mail' order by problem_id desc limit " . ($page - 1) * $page_size . "," . $page_size;
                            $result = $conn->query($str);
