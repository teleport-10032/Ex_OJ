                ...
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <table class="table table-striped table-hover table-responsive">
                            ...
                            $str = "select problem_id,problem_title,user_name,problem_create_time,problem_visible,problem_testcase_path from user,problem where user_id=problem_author and user_mail='$user_mail' and (problem_title like '%$search%' or problem_id like '%$search%') order by problem_id desc ";
                            //echo $str;
                            $result = $conn->query($str);
