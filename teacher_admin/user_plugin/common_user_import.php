...
for($i = 1; $i < $len_result; $i++) //循环获取各字段值
{
    ...
    {
        $sql = "insert into user (user_mail,user_name,user_realname,user_passwd,user_create_time,user_teacher) values ('$user_mail','$user_name','$user_realname','$user_passwd',now(),$user_id)";
...
if ($flag == 1)
{
    ...
    echo "<script>url=\"..w/user_plugin\";window.location.href=url;</script>";
}
else {
    //echo $conn->error;
