...
$page_size = 10;
$sql = "select count(*) as amount from announcement";
                ...
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <table class="table table-striped table-hover table-responsive">
                            ...
                            <tbody>
                            <?php
                            $str = "select ann_id,ann_title,ann_time,user_name,ann_visible from announcement,user where ann_author=user_id  order by ann_time desc limit " . ($page - 1) * $page_size . "," . $page_size;
                            $result = $conn->query($str);
