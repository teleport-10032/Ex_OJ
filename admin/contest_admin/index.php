...
$page_size = 5;
$sql = "select count(*) as amount from contest";
                ...
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <table class="table table-striped table-hover table-responsive">
                            ...
                            $str = "select contest_id,contest_title,user_name,contest_start_time,contest_end_time,contest_visible from user,contest where user_id=contest_author order by contest_id desc limit " . ($page - 1) * $page_size . "," . $page_size;
                            $result = $conn->query($str);
