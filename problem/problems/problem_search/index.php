        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                <table class="table">
                    ...
                    <tbody>
                    <?php
                    $str = "select problem_id,problem_title,problem_AC,problem_WA,problem_CE,problem_PE,problem_TLE,problem_MLE,problem_RE,user_name,user_mail from problem,user  where user_id=problem_author and problem_visible='1' and (problem_title like '%$search%' or problem_id like '%$search%')order by problem_id limit " . ($page - 1) * $page_size . "," . $page_size;
